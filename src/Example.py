...
def generate_graph_example():
    ...
    graphName = "example")'''
    g.set_Configuration(layerNum = 4,layerNodeNum = [8,5,10,10], outputPath = "../../mininet-manager/", 
    conPara = {"1,1": 15,"1,2": 23,"2,2": 35,"2,3": 6,"3,3":6,"3,4":1,"4,4":8},
    conDisPara= {"1,1": 1.5,"1,2": 1.5,"2,2": 1.5,"2,3": 1.5,"3,3":1.5,"3,4":1.5,"4,4":1.5},
    graphName = "example2")
    g.generate_Graph()
    print("Success")
...
def draw_graph_from_csv_example():
    ...
    t.TableSetup(G,"../../mininet-manager/example2.csv",1.2)
